...
export function CartSheetProvider({ children, currencyLabel, minimumRule }: { children: ReactNode; currencyLabel: string; minimumRule: string }) {
  ...
  return (
    <Ctx.Provider value={value}>
      {children}
      {isOpen ? <CartSheet currencyLabel={currencyLabel} minimumRule={minimumRule} /> : null}
    </Ctx.Provider>
  );
}
...
function CartSheet({ currencyLabel, minimumRule }: { currencyLabel: string; minimumRule: string }) {
